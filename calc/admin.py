...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'title', 'product_image', 'price', 'featured', 'category', 'vendor', 'products_status', 'pid']
...
class CartOrdrItemsAdmin(admin.ModelAdmin):
...
admin.site.register(CartOrdrItems, CartOrdrItemsAdmin) 
